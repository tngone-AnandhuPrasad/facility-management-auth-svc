...
public class CommunicationController : ControllerBase
{
    ...
    public CommunicationController(IMongoLayer db, IAuthenticationService authService, IEmailer emailer, ILogger logger)
    {
        ...
        /// <returns></returns>
        [HttpPost]
        public ActionResult<FacilityResponse> GenerateVerificationEmail(GenerateEmail request)
        {
    ...
    /// <param name="request"></param>
    /// <returns></returns>
        private FacilityResponse generateVerificationEmail(GenerateEmail request)
        {
    ...
    {
        string password = "SLR" + email.GetHashCode();
